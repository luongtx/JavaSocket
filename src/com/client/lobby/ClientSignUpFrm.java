...
public class ClientSignUpFrm extends javax.swing.JFrame {
    ...
    private void btnSignUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignUpActionPerformed
        ...
        if(userInput!=null) {
            ...
            if(signUpState) JOptionPane.showMessageDialog(rootPane, "Đăng ký thành công!");
            else JOptionPane.showMessageDialog(rootPane, "Tên người dùng đã tồn tại!");
        }
    ...
    public User getSignUpUser(){
        ...
        if(txtUsername.equals("") || txtPass.equals("")) {
            JOptionPane.showMessageDialog(null, "Tên người dùng và mật khẩu ko được để trống!" + txtPass);
            return null;
