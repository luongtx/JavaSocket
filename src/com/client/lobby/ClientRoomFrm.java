...
//        client.listenBattleRequest();
    ...
    private class WindowsClosedListener extends WindowAdapter{
        ...
        public void windowClosing(java.awt.event.WindowEvent windowEvent) {
            int option = JOptionPane.showConfirmDialog(rootPane, "Bạn muốn thoát?",null, JOptionPane.OK_CANCEL_OPTION);
    ...
    private void initComponents() {
        ...
        tbRoom.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tên phòng", "Chủ phòng", "Trạng thái"
            }
        ) {
    ...
    private void btnCombatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCombatActionPerformed
        ...
        if(opponentID==-1) {
            JOptionPane.showMessageDialog(rootPane, "Lựa chọn một đối thủ!");
            return;
        }
...
//tao phong
    private void btnCreateRoomActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateRoomActionPerformed
        ...
        Object[] message = { "Tên phòng: ", txtRoomName, "Sức chứa: ", txtRoomSize};
        int option = JOptionPane.showConfirmDialog(rootPane, message, "Tạo phòng mới", JOptionPane.OK_CANCEL_OPTION);
        if(option==JOptionPane.OK_OPTION){
            if(txtRoomName.getText().equals("") || txtRoomSize.getText().equals("")) {
                JOptionPane.showMessageDialog(rootPane, "Nhập tên phòng và sức chứa!");
                return;
            }else if(txtRoomName.getText().contains(" ")){
                JOptionPane.showMessageDialog(rootPane, "Tên phòng không chứa khoảng trắng");
                return;
            }
            try{
    ...
    private void btnJoinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJoinActionPerformed
        ...
        if(roomID==-1) {
            JOptionPane.showMessageDialog(null, "Chọn một phòng!");
            return;
        }
//        System.out.println(roomName);
    ...
    private void btnDeleteRoomActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteRoomActionPerformed
        ...
        int roomID = tbRoom.getSelectedRow();
        if(roomID==-1) {
            JOptionPane.showMessageDialog(rootPane, "Chọn một phòng!");
            return;
        }
