...
public class ClientLoginFrm extends javax.swing.JFrame {
     ...
     */
    Client client;
    public ClientLoginFrm(Client client) {
        initComponents();
        this.client = client;
//        this.addWindowListener(new WindowsClosedListener());
    ...
    private void lbSignUpMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbSignUpMouseClicked
        ...
        new ClientSignUpFrm(client).setVisible(true);
        dispose();
    ...
    public User getInputUser(){
        ...
        User user = null;
        if(txtUsername.equals("")) JOptionPane.showMessageDialog(rootPane, "Chưa nhập tên tài khoản!");
        else if(txtPass.equals("")) JOptionPane.showMessageDialog(rootPane, "Chưa nhập mật khẩu!");
        else user = new User(txtUsername, txtPass);
        return user;
    }
    /**
